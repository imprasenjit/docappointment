...
$(window).load(function(){
    ...
    function checkAvailableSchedule(doctor_id, date, time)
    {
        $.ajax({
            ...
            url: '<?= site_url()?>/f/appointment/check_avaiable_schedule/',
            method: 'post',
    ...
    function searchDoctor(specialization)
    {
        $.ajax({
            ...
            url: '<?= site_url()?>/f/doctor/display_doctor_by_keys/',
            method: 'post',
...
/*    Date.prototype.addDays = function(days) 
    ...
    function getDoctorShifts(doctor_id, date)
    {
        ...
        $.ajax({
            url: '<?= site_url()?>/f/schedule/get_schedule_by_doc_id_lookup/' + doctor_id,
            method: 'post',
            data: {'date': date},
            success: function(data)
            {
...
/*    function getDoctorSchedule(id)
    {
        $.ajax({
            ...
            url: '<?= site_url()?>/f/schedule/get_schedules_by_doc_id_lookup/' + id,
            success: function(data)
            {
    ...
    $('#submitted_date_1, #submitted_date_2').change(function(){
        ...
        $.ajax({
            ...
            url: '<?= site_url()?>/f/appointment/get_doctors_by_date_lookup/' + date,
            success: function(data)
            {
    ...
    $(window).load(function() {
        ...
        change: function() {
            ...
            if(old_cnic.length > 0)
            {
                ...
                $.ajax({
                    url: '<?= site_url()?>/a/autocomplete/mr_number_autocomplete/',
                    method: 'post',
