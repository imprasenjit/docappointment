    ...
    <script>
        ...
        function printPrescription(id) 
        {
            ...
            {
                jQuery.ajax({
                    url: '<?=site_url();?>/a/' + controller + '/prescription_by_id_lookup/' + id,
                    // method: 'post',
                    // data: data,
	...
	<script>
        function getModal(id = 0, url = '', controller, del_view = '')
        {
            ...
            jQuery.ajax({
                url: '<?=site_url();?>/a/' + controller + '/get_modal/' + id,
                method: 'post',
                data: data,
                success: function(data)
                {
...
*/
    ...
    function reschedule_save(id)
    {
        ...
        if(controller === 'schedule')
        {
            ...
            $.ajax({
                url: '<?=site_url();?>/a/appointment/reschedule_appointment_lookup/' + id,
                method: 'post',
...
/*        $(window).on('load', function() {
    ...
    <script>
        ...
        {    
            ...
            var second_shift_end = $('#second_shift_end').val().trim();
            $.ajax({
                url: '<?=site_url();?>/a/' + controller  + '/edit_schedule_lookup/' + id,
                method: 'post',
    ...
    <script>
        ...
        $(window).on('load', function() {
            $(document).on('click','.edit_schedule_form_modal_id',function(){
                ...
                var controller = $('#controller_name').val().trim();
                $.ajax({
                    url: '<?=site_url();?>/a/' + controller  + '/get_modal/' + 'second_popup',
                    method: 'post',
                    data: {'id': id},
                    success: function(data)
                    {
...
/*    
    ...
    {
        $.ajax({
            url: '<?=site_url();?>/a/appointment/get_unapproved_appointments_count_lookup',
            method: 'POST',
            success: function(data)
            {
...
/*    
    ...
    {
        $.ajax({
            url: '<?=site_url();?>/a/appointment/get_unapproved_appointments_lookup',
            method: 'POST',
            success: function(data)
            {
            ...
            $(document).on('submit', '#add_prescription_form',function(e) {
                ...
                if(1)
                {
                    $.ajax({
                        ...
                        url: '<?=site_url();?>/a/prescription/add_prescription_lookup/',
                        method: 'post',
...
<script>
    ...
    function getTime(id, date)
    {
        return $.ajax({
            ...
            url: '<?=site_url();?>/a/schedule/get_schedule_by_doc_id_lookup/' + id,
            method: 'post',
            data: {'date': date},
    ...
    <script>
        function searchAppointment(date, time, mr_number)
        {
            $.ajax({
                ...
                url: '<?=site_url();?>/a/autocomplete/display_patients/',
                method: 'post',
    ...
    <script>
        function searchAppointmentByDoctor(doctor, time)
        {
            ...
            $.ajax({
                ...
                url: '<?=site_url();?>/a/autocomplete/display_appointments/',
                method: 'post',
        ...
        function searchSchedule(date, day, doctor)
        {
            $.ajax({
                ...
                url: '<?=site_url();?>/a/autocomplete/display_schedules/',
                method: 'post',
    ...
    <script>
        ...
        function searchPatient(mr_number, father_name, mobile_number)
        {
            $.ajax({
                ...
                url: '<?=site_url();?>/a/autocomplete/display_patient_by_keys/',
                method: 'post',
        ...
        function searchPrescription(date, time, mr_number, doctor_name)
        {
            $.ajax({
                ...
                url: '<?=site_url();?>/a/autocomplete/get_prescription_by_keys/',
                method: 'post',
        ...
        function searchDoctor(specialization, doctor_name, mobile_number)
        {
            $.ajax({
                ...
                url: '<?=site_url();?>/a/autocomplete/display_doctor_by_keys/',
                method: 'post',
    ...
    <script>
        $('.schedule_form').on('submit', function(e){
                ...
                if(empty === 0)
                {
                    ...
                    jQuery.ajax({
                        url: '<?=site_url();?>/a/' + controller + '/get_modal/' + 'edit_popup',
                        method: 'post',
                        data: data,
                        success: function(data)
                        {
        ...
        dayClick: function(date, jsEvent, view) 
        {
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    url: '<?=site_url();?>/f/appointment/get_doctors_by_date_lookup/' + clicked_date,
                    success: function(data)
                    {
                        $('#doctor').html(data);
        ...
        $(window).on('load', function() {
            ...
            if(controller === 'schedule')
            {
                $('#edit').on('click', function(e) {
                    ...
                    var second_shift_end = $('#second_shift_end').val();
                    $.ajax({
                        url: '<?=site_url();?>/a/appointment/get_appointments_by_date_lookup/',
                        method: 'post',
...
<footer class="text-center"> Netro Technologies Admin v1.0 &copy; 2016</footer>
