...
defined('ADMIN_ASSETS') OR define('ADMIN_ASSETS', "http://localhost/appointment/" . '/assets/admin/');
...
defined('FRONT_END_ASSETS') OR define('FRONT_END_ASSETS', "http://localhost/appointment/" . '/assets/front_end/' );
...
define('IMAGE_PATH', "http://localhost/appointment/" . '/assets/admin/images/doctors/' );
